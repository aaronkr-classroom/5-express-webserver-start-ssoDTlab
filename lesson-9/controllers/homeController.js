...
exports.getHome = (req,res,) => {
    res.send("This ist the <span style = 'color:red'>HOME </span? page.");
} // @TODO: exports 객체를 사용해 getHome 함수를 모듈로 내보낸다
exports.getAbout = (req,res,) => {
    res.send("This ist the <span style = 'color:green'>ABOUT</span> page.");
}
exports.getContact = (req,res,) => {
    res.send("This ist the <span style = 'color: orange'>CONTACT</span> page.");
} // @TODO: exports 객체를 사용해 getContact 함수를 모듈로 내보낸다

exports.postContact = (req,res,) => {
    res.send("Contact info submit!!!.");
